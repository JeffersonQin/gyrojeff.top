...
<td><a href="https://zh.wikipedia.org/wiki/%E5%B9%B3%E9%9D%A2%E4%B8%89%E8%A7%92%E5%BD%A2%E5%88%86%E5%AD%90%E6%9E%84%E5%9E%8B" title="平面三角形分子构型">平面三角形<br><b><font color="red">Trigonal Planar</font></b><br><b><font color="red">120°</font></b></a>
</td>
...
<td><a href="https://zh.wikipedia.org/wiki/%E6%B0%A8" title="氨">NH<sub>3</sub></a>、<a href="https://zh.wikipedia.org/wiki/%E4%B8%89%E6%B0%AF%E5%8C%96%E7%A3%B7" title="三氯化磷">PCl<sub>3</sub></a>
</td></tr>
<tr>
...
<td><a href="https://zh.wikipedia.org/wiki/%E4%B8%89%E6%B0%9F%E5%8C%96%E6%B0%AF" title="三氟化氯">ClF<sub>3</sub></a>、<a href="https://zh.wikipedia.org/wiki/%E4%B8%89%E6%B0%9F%E5%8C%96%E6%BA%B4" title="三氟化溴">BrF<sub>3</sub></a>
</td></tr>
<tr>
...
<td><a href="https://zh.wikipedia.org/wiki/%E5%9B%9B%E6%B0%9F%E5%8C%96%E6%B0%99" title="四氟化氙">XeF<sub>4</sub></a>
</td></tr>
</tbody></table>
...
1. **Particle must collide 必须碰撞**
2. **Sufficient Energy 足够的能量**
3. **Correct Orientation 正确的碰撞角度**

### 5.1.2 过渡态理论 - Transition State Theory

过渡态理论即活化络合物理论，（transition-state theory）。过渡态：以量子力学对反应过程中的能量变化的研究为依据，认为从反应物到生成物之间形成了势能较高的**活化络合物**，**活化络合物**所处的状态叫过渡态。

![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210220215307_fc99c56fada991154e6cc40b59416e5c.png)

![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210220214949_3c4d4f33ad860f613d4d7065970ce9b1.png)

![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210220215026_c796d3f8259eee4eac74938b091eaf17.png)
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210220234854_76a2082dc9e9f0ea0586f99fb7eb495b.png)
...
<div class="tip tip-handsome inlineBlock warning">如果参加反应的物质全部是固体、液体或溶液时,改变压强对它们的反应速率无影响。</div>
<div class="tip tip-handsome inlineBlock warning">改变压强一般指改变体积。如果是充入其他气体，对气体浓度没有影响，所以不会有什么影响。</div>
...
- $k$是**速率常数 Rate Constant**，**不同反应有不同的速率常数，速率常数与反应温度、反应介质（溶剂）、催化剂等有关，甚至会随反应器的形状、性质而异。与浓度无关，但受温度、催化剂、固体表面性质等因素的影响。**但是，**<font color="red">和浓度无关！！</font>**
- $[\text A], [\text B], [\text C]$是**浓度**
- $x, y, z$是需要我们求解的**反应级数 Reaction Orders**
...
如果一种物质在一个反应中的反应级数为$1$，那么这种物质在这种反应当中的**半衰期**是**常数**。推导：
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210222082815_1da9f5661b5980babea7e22e8f69172c.png)
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210222083316_b3e635ca143c7b0a0b2f5e4d20fe1557.png)
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210222084009_21846d24e6579db104170293c149b978.png)
...
**<font color="red">慢反应速率决定总反应速率。</font>**（木桶原理）
...
**<font color="red">慢反应是活化能高的反应。</font>**
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210222100844_611faffc47c20e2255b7af22dc4ee2e7.png)
...
2. 物理变化：
   ...
   意义：$1 \text {mol}$液态水变成气体，吸收$44\text { kJ}$的热量。
3. 化学变化：
   $$\ce {C (s) + O2 (g) -> CO2 (g) + 393.5 kJ}$$
   意义：$1 \text { mol}$的固态$\ce {C}$和$1 \text { mol}$的氧气反应，生成一摩尔的二氧化碳气体并放出393.5千焦的热量。
<div class="note success">要注意量、状态</div>
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210222110307_c610a1a9ce039e7d354e9ecbd6c71729.png)

![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210222110344_8447f9b77357e80222d2cd3ebead2a0a.png)

![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210222110432_d4b0bb86c9c2997f6f291c3a5d6baeff.png)

### 6.2.3 热化学反应方程式
表示化学反应中吸收或放出的能量的化学方程式

<div class="tip tip-handsome inlineBlock warning">热化学反应方程式中可以出现分数、小数、整数，但是不可以全部是分数</div>
<div class="tip tip-handsome inlineBlock info">热化学方程式中的系数之比不表示微粒数之比，表示物质的量</div>
<div class="tip tip-handsome inlineBlock success">反应物、生成物必须标明状态</div>
<div class="tip tip-handsome inlineBlock success">热化学反应方程式不用写反应条件</div>
<div class="tip tip-handsome inlineBlock warning">Tip: 想要得到想要的热化学反应方程式，可以相加减。</div>
...
<div class="para" label-module="para">状态函数（state function），即指表征体系特性的宏观性质，多数指具有能量<a target="_blank" href="https://baike.baidu.com/item/%E9%87%8F%E7%BA%B2/100412" data-lemmaid="100412">量纲</a>的<a target="_blank" href="https://baike.baidu.com/item/%E7%83%AD%E5%8A%9B%E5%AD%A6%E5%87%BD%E6%95%B0/12728584" data-lemmaid="12728584">热力学函数</a>（如内能、<a target="_blank" href="https://baike.baidu.com/item/%E7%84%93/1132984" data-lemmaid="1132984">焓</a>、<a target="_blank" href="https://baike.baidu.com/item/%E5%90%89%E5%B8%83%E6%96%AF%E8%87%AA%E7%94%B1%E8%83%BD/327614" data-lemmaid="327614">吉布斯自由能</a>、亥姆霍茨<a target="_blank" href="https://baike.baidu.com/item/%E8%87%AA%E7%94%B1%E8%83%BD/813477" data-lemmaid="813477">自由能</a>）。主要应用于工程领域。</div><div class="para" label-module="para">状态函数只对<a target="_blank" href="https://baike.baidu.com/item/%E5%B9%B3%E8%A1%A1%E7%8A%B6%E6%80%81/1530915" data-lemmaid="1530915">平衡状态</a>的体系有确定值，其变化值只取决于系统的始态和终态。另外，状态函数之间相互关联、相互制约。</div><div class="para" label-module="para">状态函数按其性质可分为两类，即<a target="_blank" href="https://baike.baidu.com/item/%E5%B9%BF%E5%BA%A6%E6%80%A7%E8%B4%A8/10829945" data-lemmaid="10829945">广度性质</a>和<a target="_blank" href="https://baike.baidu.com/item/%E5%BC%BA%E5%BA%A6%E6%80%A7%E8%B4%A8/6832998" data-lemmaid="6832998">强度性质</a>，其区别在于是否与<a target="_blank" href="https://baike.baidu.com/item/%E7%89%A9%E8%B4%A8%E7%9A%84%E9%87%8F/867572" data-lemmaid="867572">物质的量</a>有关。</div>
</div>

<div class="tip tip-handsome inlineBlock warning">

**<font color="red">只和初末状态有关！！</font>**
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210222104329_547e756e509054ca6c76d81c59b3d8fd.png)
...
生成焓是**某温度下**，用处于**标准状态(Standard State Condition)**的各种元素的**最稳定单质**（最稳定单质如液态溴、固态碘、石墨、白磷、斜方硫等。）生成标准状态下单位物质的量（1mol）某纯物质的热效应，也称生成热。表示为$\Delta H_f$

<div class="tip tip-handsome inlineBlock warning">

**<font color="red">最稳定的单质的生成焓为$0$！！</font>**。原因：状态函数只和初末状态有关。$单质 \Rightarrow 单质$，所以$\Delta H_f = 0$
...
**<font color="red">第七章化学平衡当中的常数都是热化学常数！！！</font>**

**<font color="red">热化学常数只和温度有关！！！</font>**
...
**<font color="red">第五章速率方程当中的常数是动力学常数！！！</font>**

**<font color="red">第七章化学平衡当中的常数都是热化学常数！！！</font>**

**<font color="red">虽然都是$k$, 但是一定要区分开！</font>**
...
<div class="tip tip-handsome inlineBlock warning">生成溶液的过程既不是物理变化，也不是化学变化，是物理化学变化</div>
...
<div class="tip tip-handsome inlineBlock warning">溶解过程和结晶过程同时存在，是一组相反的过程</div>
...
<div class="tip tip-handsome inlineBlock warning">溶解平衡：与外界条件（温度、溶剂量等）有关</div>
<div class="tip tip-handsome inlineBlock warning">改变外界条件（升温、加水等），原来的平衡被破坏，在新的条件下达到新的平衡 -- 平衡发生移动。</div>
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210224154008_84b7c5b5a7dcf19058fe03d0b1b9117f.png)
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210224154236_0f13ce3b431cd693214284e97f053b89.png)
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210224154351_5c8689bf2c0a97509bf5de82ef7c43e5.png)
...
**<font color="red">固体(l)和液体(s)在这里算作是纯净的东西，不写进平衡常数。所以写在平很常数里的只有溶液(aq)和气体(g)</font>**
...
<div class="tip tip-handsome inlineBlock warning">注：是减弱，不是抵消</div>
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210222125620_8787bf21f66b1f5347f20f85e11f2dfa.png)
...
- $\ce {HX}$是**酸**，**失去了质子**，**形成了**它的**共轭碱**$\ce {X-}$
- $\ce {H2O}$是**碱**，**得到了质子**，**形成了**它的**共轭酸**$\ce {H3O+}$

#### 8.1.7.2 如何判断共轭酸碱对？

**<font color="red">共轭酸比共轭碱多一个$\ce {H+}$（质子）</font>**

#### 8.1.7.3 共轭酸碱对的重要的三句话

<div class="tip tip-handsome inlineBlock warning"><b><font color="red">共轭酸碱对是相对的！！！！</font></b></div>

![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210223145715_6d753f6b356c2df8bf54ed81f2642adb.png)
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210223151827_f64154cf882c3230fee2bdf988cdfc28.png)
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210223151946_aac0b52b6b9620b1c1616fd408864ff1.png)
...
**<font color="red">Standard Solution / Titrant</font>**
...
- **强酸强碱滴定**，等当量点pH值**等于7**，因为生成**强酸强碱盐**
- **强酸滴定弱碱**，等当量点pH值**小于7**，因为生成**强酸弱碱盐**
- **强碱滴定弱酸**，等当量点pH值**大于7**，因为生成**强碱弱酸盐**

### 8.3.5 不同酸碱滴定终点的pH比较

- 待滴定的酸，**酸性越弱**，**$K_a$值越低**，生成的**共轭碱碱性越强**，**$K_b$值越大**，等当量点**pH值越高**
- 待滴定的碱，**碱性越弱**，**$K_b$值越低**，生成的**共轭酸酸性越强**，**$K_a$值越大**，等当量点**pH值越低**
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210224124119_9b0ca1c3963e7472a8014fc04275f27e.png)
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210224130655_4d181456985e5cb24518a328c188e73b.png)

# Unit 9 热化学的应用 - Applications of Thermodynamics

<div class="tip tip-handsome inlineBlock warning">注：Unit 9.1是熵与吉布斯自由能，放在Unit 6热化学后。Unit 9.2为溶解中的热现象，也归在Unit 6内。</div>
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210224223333_571c214cd765c05001602369d7de6248.png)
...
- **还原电势**：描述物质**得电子**的趋势 (tendency)
- **氧化电势**：描述物质**失电子**的趋势 (tendency)
...
**<font color="red">两个半反应拼成一个反应时，不需要管系数，直接将$E^\circ$相加！！</font>**
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210225130732_f434eea768eb12dac439161ceaa0d682.png)
...
- 以阳极为例：**阳极**发生**氧化反应**，**化合价升高**，**失电子**。那么，在所有可以发生的氧化半反应当中，**氧化电势最高**的那个，**最先发生**。即，**失电子能力最强**。
- 以阴极为例：**阴极**发生**还原反应**，**化合价降低**，**得电子**。那么，在所有可以发生的还原半反应当中，**还原电势最高**的那个，**最先发生**。即，**得电子能力最强**
...
<div class="tip tip-handsome inlineBlock share">在电化学中，过电位是半反应的热力学确定的还原电位与实验观察到的氧化还原反应的电位之间的电位差（电压）。该术语与电池的电压效率直接相关。在电解池中，超电势的存在意味着电池需要比热力学预期驱动反应更多的能量。在原电池中，过电位的存在意味着比热力学更少的能量被回收预测。在每种情况下，多余的/缺失的能量都会作为热量流失。过电位的数量是特定于每个单元设计的，并且在单元和操作条件之间变化，即使对于相同的反应。过电位通过测量实现给定电流密度（通常小）的电位来实验确定。</div>

#### 9.3.2.5 电解池的应用 - 电镀

![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210225190045_8f4d59174fd6d66ed903d76802a563ab.png)
...
<div class="tip tip-handsome inlineBlock warning">由于课内学了挺多了，这里只记录化学物质名称</div>
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210226100520_633a3ab15bff686993eb7a700986ac9c.png)

### A.3.5 蒸馏 - Distillation

![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210226100539_f6a9c6856f7c67ce13fa1aed04d2c527.png)
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210226100953_eeecdd19a71ddc8ba9b18288bd1d249a.png)

注意：集满时，内部压强等于大气压，且需要注意**水蒸气的分压**，不如：
...
![](https://cdn.jsdelivr.net/gh/JeffersonQin/blog-asset@latest/usr/vscode/20210226101138_c3a5214b76c5c1ae5fbf396dc21282c7.png)
...
看FRQ的答案，**<font color="red">式量貌似要小数点后两位</font>**，具体的按照考试的时候那张表上的。
