...
authorId: 1
categories: [技术]
created: '2022-03-31 22:30:20'
fields: {customSummary: '', mathjax: auto, noThumbInfoStyle: default, outdatedNotice: 'no',
  reprint: standard, thumb: '', thumbDesc: '', thumbSmall: '', thumbStyle: default}
modified: '2022-03-31 22:30:20'
parent: 0
password: ''
...
&2~~~~\bold{while} \text{ there exists an augmenting path } p \text{ in the residual network }G_f \\
...
&2~~~~~~~~~~~~(u,v).f = 0\\
&3~~~~\bold{while}\text{ there exist a path from }s\text{ to }t\text{ in the residual network }G_f \\
&4~~~~~~~~~~~~c_f(p) = \min\{c_f(u,v) ~| ~(u,v) \text{ is in the route }p\} \\
&5~~~~~~~~~~~~\bold{for }\text{ each edge }(u,v)\text{ in }p \\
&6~~~~~~~~~~~~~~~~~~~~\bold{if}\text{ }(u,v) \in E \\
&7~~~~~~~~~~~~~~~~~~~~~~~~~~~~(u,v).f = (u,v).f+c_f(p) \\
...
1&4~~~~\bold{return}\text{ }\sum_{v \in G.V}f(s,v)
\end {aligned}
$$
